<template>
  <div class="wrapper">
    <b-collapse
      ...
      :open="false"
      animation="slide"
      aria-id="collapsible-component-wrapper"
    >
      <!-- 
      ...
      <template #trigger="props">
        ...
        >
          <p class="card-header-title">Having problems uploading?</p>
      ...
      <div class="card-content">
        <ul>
          <li>
            Please try using on the NBI site, with a wired network cable
            connection.
          </li>
          <li>
            ...
            <div class="subcontent-indent-small">
              ...
              >
                <template #trigger="props">
                  <a aria-controls="remote-download-faq">
                    ...
                    {{
                      props.open
                        ? "OK, got it!"
                        : "Show me how to optimise remote site downloading anyway"
                    }}
                  </a>
                </template>
                <div class="subcontent-indent-large">
                  <ol type="1">
                    <li>
                      Upload files to your OneDrive account (without a VPN
                      connection)
                    </li>
                    <li>
                      Use a VPN +
                    ...
                    <li>
                      On the RDS, navigate to this site with a browser such as
                      Chrome
                    </li>
          ...
          <li>
            Please use a modern browser, i.e. a recent version of: Chrome,
            Firefox, Edge, Safari. (Not for example Internet Explorer 11!)
          </li>
          <li>
            Max file upload size is 100GB. Please
            <a href="mailto:george.deeks@tsl.ac.uk"
              >contact the system administrator</a
            >
            if your file size is going to be larger than this.
          </li>
          <li>
            Any further questions or problems, then please
            <a href="mailto:george.deeks@tsl.ac.uk"
              >contact the system administrator</a
            >.
          </li>
