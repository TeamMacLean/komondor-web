        ...
        <div class="column is-4 is-3-desktop">
          <div class="columns is-mobile is-multiline">
            ...
            <div class="column is-8-mobile is-full-tablet">
              ...
              <h2 v-if="fullName !== username" class="subtitle">
                {{ username }}
              </h2>
              <p>
                <b-icon
              ...
              <p>
                <b-icon icon="domain" size="is-small" class="has-text-grey" />
                <a
                  v-if="email !== 'Unknown email'"
                  :href="'mailto:' + email"
                  target="_blank"
                  >{{ email }}</a
                >
...
export default {
  ...
  asyncData({ route, $axios, error }) {
    ...
    return $axios
      .get("/user", {
        params: { username: route.query.username, projects: true },
      })
      .then((res) => {
        if (res.status === 200) {
          if (res.data.user) {
